...
class BeerList : Fragment() {
                    ...
                    Glide.with(this).asBitmap().load(beer.image_url)
                        .into(object : CustomTarget<Bitmap?>(){
                            override fun onResourceReady(
                                ...
                                viewModel.insertBeer(model(beer.pk,resource,beer.name,beer.tagline,beer.abv,beer.description,beer.food_pairing,beer.brewers_tips))
                            }
    ...
    fun IsShimmerEffectOn(isDisplayed: Boolean) {
        if(isDisplayed){
